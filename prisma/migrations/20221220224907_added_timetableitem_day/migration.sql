/*
  ...
  - Added the required column `day` to the `TimetableItem` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_TimetableItem" ("id", "subjectId", "timeFrom", "timeTo", "timetableId") SELECT "id", "subjectId", "timeFrom", "timeTo", "timetableId" FROM "TimetableItem";
